...
GpioPin g_uartTx{ *GPIOA, { 2, PinMode::AlternateFunction, PullMode::None, OutputSpeed::VeryHigh, OutputType::PushPull, 7 } };
GpioPin g_uartRx{ *GPIOA, { 3, PinMode::AlternateFunction, PullMode::None, OutputSpeed::VeryHigh, OutputType::PushPull, 7 } };
GpioPin g_i2cScl{ *GPIOB, { 6, PinMode::AlternateFunction, PullMode::PullUp, OutputSpeed::VeryHigh, OutputType::OpenDrain, 4 } };
GpioPin g_i2cSda{ *GPIOB, { 7, PinMode::AlternateFunction, PullMode::PullUp, OutputSpeed::VeryHigh, OutputType::OpenDrain, 4 } };
...
Uart<> g_uart2{ *USART2, USART2_IRQn, { .baudrate = 115200, .dataBits = 8, .stopBits = 1, .parity = Parity::None } };
sensor::Mpu6050 g_mpu{ g_i2c1, { .addr = 0x68, .accelRange = 2, .gyroRange = 250, .sampleRateDiv = 7, .dlpfMode = 6 } };
